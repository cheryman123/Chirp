<?php
    ...
    if (empty($_GET['limit'])) {
        header("Location: MineaccountGazette.php?cat=1&start=0&limit=".$limit."");
    }
?>
    ...
    <div class="topnav">
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <object><a href="?cat=1&start=0&limit=<?php echo $limit; ?>">Latest</a></object>
                <object><a href="?cat=2&start=0&limit=<?php echo $limit; ?>">Most Viewed</a></object>
                <object><a href="?cat=3&start=0&limit=<?php echo $limit; ?>">Most Karma</a></object>
                <object><a href="?cat=4&start=0&limit=<?php echo $limit; ?>">Most Upvoted</a></object>
                <object><a href="?cat=5&start=0&limit=<?php echo $limit; ?>">Most Downvoted</a></object>
            </div>
        </div>
            ...
            echo "<div style='display: inline-block;'>";
                echo "<div style='display: grid; grid-template-columns: 100px 50px 100px; align-self: center; justify-self: center;'>";
                    ...
                    if ($_GET['start'] == 0) {
                        ...
                        echo "<a href='?cat=".$_GET['cat']."&start=".$startprevious."&limit=".$limit."'>
                    ...
                    echo "<a href='?cat=".$_GET['cat']."&start=".$startnext."&limit=".$limit."'>
