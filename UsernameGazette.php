...
<head>
    ...
    <div id='LogSignpageMobileDivDivider' style='display: grid; grid-template-columns: 50%; padding: 6px 6px 6px 6px;'>
        <div class='asidebox' style='background-color: #1A1A1B;'>
            <div style=''>
                <h1 class='signuptext' style='color: #F2eecb; font-size: 16px;'>Send a username list to your email.</h1>
            </div>
        </div>
        <div class="logbox">
            <form action="include/username.inc.php" method="post">
                            ...
                            <?php
                                if (isset ($_GET['reset'])){
                                    ...
                                    if ($_GET['reset'] == "success") {
                                        echo '<h1 class="signuptext" style="color: #bb0000; margin-top: 6px; margin-bottom: 6px; float: left;">Your username list has been sent!</h1>';
                                    }
